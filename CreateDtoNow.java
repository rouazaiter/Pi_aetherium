...
public class CreateDtoNow {
    public static void main(String[] args) throws Exception {
        ...
        Files.write(Paths.get(basePath, "SkillNodeDto.java"), skillContent.getBytes());
        ...
        Files.write(Paths.get(basePath, "PortfolioDNADto.java"), dnaContent.getBytes());

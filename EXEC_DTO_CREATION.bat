...
md "C:\Users\jihen\Downloads\portfolio\src\main\java\jihen\portfolio\dto" 2>nul
...
REM Create SkillNodeDto.java using a heredoc-like approach
(
...
for %%A in ("C:\Users\jihen\Downloads\portfolio\src\main\java\jihen\portfolio\dto\*") do (
	if exist "%%A" (
		echo   - %%~nxA
	)
)

REM Display SkillNodeDto.java content
echo.
echo ======================================================================
...
REM Display PortfolioDNADto.java content
echo.
echo ======================================================================

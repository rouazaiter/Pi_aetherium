...
mkdir "%CD%\src\main\java\jihen\portfolio\dto" 2>nul
...
echo }
) > "%CD%\src\main\java\jihen\portfolio\dto\SkillNodeDto.java"
...
echo }
) > "%CD%\src\main\java\jihen\portfolio\dto\PortfolioDNADto.java"

import {
  getIconStyles
} from "./chunk-AXFZWBTO.js";
import {
  Graph,
  clone_default
} from "./chunk-UF5NINS7.js";
import {
  computeLabelTransform,
  getLineFunctionsWithOffset
} from "./chunk-YA547GGI.js";
import {
  configureLabelImages,
  getSubGraphTitleMargins
} from "./chunk-PGOY7VLQ.js";
import {
  createText
...
var createLabel = __name((element, _vertexText, style, isTitle = false, isNode = false) => __async(void 0, null, function* () {
...
var edgeLabels = {};
var terminalLabels = {};
var insertEdgeLabel = __name((elem, edge) => __async(void 0, null, function* () {
  const config2 = getConfig2();
  const useHtmlLabels = getEffectiveHtmlLabels(config2);
  const edgeLabel = elem.insert("g").attr("class", "edgeLabel");
  const label = edgeLabel.insert("g").attr("class", "label");
  const isMarkdown = edge.labelType === "markdown";
  const labelElement = yield createText(
    elem,
    edge.label,
    {
  ...
  if (edge.startLabelRight) {
    ...
    const startLabelElement = yield createLabel_default(
      startEdgeLabelRight,
...
var labelHelper = __name((parent, node, _classes, isNode) => __async(void 0, null, function* () {
  const config2 = getConfig2();
  let classes2;
  ...
  if (node.labelType === "markdown") {
    ...
    text = yield createLabel_default(
      label,
      sanitizeText(decodeEntities(labelText), config2),
      node.labelStyle,
      false,
...
var note = __name((parent, node) => __async(void 0, null, function* () {
  const useHtmlLabels = node.useHtmlLabels || getEffectiveHtmlLabels(getConfig2());
  if (!useHtmlLabels) {
    node.centerLabel = true;
  }
  const { shapeSvg, bbox, halfPadding } = yield labelHelper(
    parent,
    node,
    "node " + node.classes,
    true
...
var question = __name((parent, node) => __async(void 0, null, function* () {
  const { shapeSvg, bbox } = yield labelHelper(
    parent,
    node,
...
var hexagon = __name((parent, node) => __async(void 0, null, function* () {
  const { shapeSvg, bbox } = yield labelHelper(
    parent,
    node,
    getClassesFromNode(node, void 0),
...
var block_arrow = __name((parent, node) => __async(void 0, null, function* () {
  const { shapeSvg, bbox } = yield labelHelper(parent, node, void 0, true);
  const f = 2;
...
var rect_left_inv_arrow = __name((parent, node) => __async(void 0, null, function* () {
  const { shapeSvg, bbox } = yield labelHelper(
    parent,
    node,
    getClassesFromNode(node, void 0),
...
var lean_right = __name((parent, node) => __async(void 0, null, function* () {
  const { shapeSvg, bbox } = yield labelHelper(parent, node, getClassesFromNode(node), true);
  const w = bbox.width + node.padding;
  const h = bbox.height + node.padding;
  const points = [
    { x: -2 * h / 6, y: 0 },
...
var lean_left = __name((parent, node) => __async(void 0, null, function* () {
  const { shapeSvg, bbox } = yield labelHelper(
    parent,
    node,
    getClassesFromNode(node, void 0),
...
var trapezoid = __name((parent, node) => __async(void 0, null, function* () {
  const { shapeSvg, bbox } = yield labelHelper(
    parent,
    node,
    getClassesFromNode(node, void 0),
...
var inv_trapezoid = __name((parent, node) => __async(void 0, null, function* () {
  const { shapeSvg, bbox } = yield labelHelper(
    parent,
    node,
    getClassesFromNode(node, void 0),
...
var rect_right_inv_arrow = __name((parent, node) => __async(void 0, null, function* () {
  const { shapeSvg, bbox } = yield labelHelper(
    parent,
    node,
    getClassesFromNode(node, void 0),
...
var cylinder = __name((parent, node) => __async(void 0, null, function* () {
  const { shapeSvg, bbox } = yield labelHelper(
    parent,
    node,
    getClassesFromNode(node, void 0),
...
var rect = __name((parent, node) => __async(void 0, null, function* () {
  const { shapeSvg, bbox, halfPadding } = yield labelHelper(
    parent,
    node,
...
var composite = __name((parent, node) => __async(void 0, null, function* () {
  const { shapeSvg, bbox, halfPadding } = yield labelHelper(
    parent,
    node,
    "node " + node.classes,
...
var labelRect = __name((parent, node) => __async(void 0, null, function* () {
  const { shapeSvg } = yield labelHelper(parent, node, "label", true);
...
var rectWithTitle = __name((parent, node) => __async(void 0, null, function* () {
  let classes2;
  if (!node.classes) {
    classes2 = "node default";
  } else {
  ...
  const descr = yield createLabel_default(
    label,
...
var stadium = __name((parent, node) => __async(void 0, null, function* () {
  const { shapeSvg, bbox } = yield labelHelper(
    parent,
    node,
    getClassesFromNode(node, void 0),
...
var circle2 = __name((parent, node) => __async(void 0, null, function* () {
  const { shapeSvg, bbox, halfPadding } = yield labelHelper(
    parent,
    node,
    getClassesFromNode(node, void 0),
...
var doublecircle = __name((parent, node) => __async(void 0, null, function* () {
  const { shapeSvg, bbox, halfPadding } = yield labelHelper(
    parent,
    node,
    getClassesFromNode(node, void 0),
...
var subroutine = __name((parent, node) => __async(void 0, null, function* () {
  const { shapeSvg, bbox } = yield labelHelper(
    parent,
    node,
    getClassesFromNode(node, void 0),
...
var class_box = __name((parent, node) => __async(void 0, null, function* () {
  const halfPadding = node.padding / 2;
  const rowPadding = 4;
  const lineHeight = 8;
  let classes2;
  ...
  const interfaceLabel = yield createLabel_default(
    labelContainer,
    interfaceLabelText,
    node.labelStyle,
    true,
  ...
  const classTitleLabel = yield createLabel_default(
    labelContainer,
    classTitleString,
    node.labelStyle,
    true,
  ...
  node.classData.members.forEach((member) => __async(void 0, null, function* () {
    const parsedInfo = member.getDisplayDetails();
    let parsedText = parsedInfo.displayText;
    if (getEffectiveHtmlLabels(getConfig2())) {
      parsedText = parsedText.replace(/</g, "&lt;").replace(/>/g, "&gt;");
    }
    const lbl = yield createLabel_default(
      labelContainer,
      parsedText,
  ...
  const classMethods = [];
  node.classData.methods.forEach((member) => __async(void 0, null, function* () {
    const parsedInfo = member.getDisplayDetails();
...
var nodeElems = {};
var insertNode = __name((elem, node, renderOptions) => __async(void 0, null, function* () {
  let newEl;
  let el;
  if (node.link) {
    let target;
...
function calculateBlockSize(elem, block, db2) {
  return __async(this, null, function* () {
    ...
    const nodeEl = yield insertNode(elem, node, { config: config2 });
...
function insertBlockPositioned(elem, block, db2) {
  return __async(this, null, function* () {
    ...
    if (obj.type !== "space") {
      const config2 = getConfig();
      yield insertNode(elem, node, { config: config2 });
...
//# sourceMappingURL=blockDiagram-DXYQGD6D-5PX5N24I.js.map

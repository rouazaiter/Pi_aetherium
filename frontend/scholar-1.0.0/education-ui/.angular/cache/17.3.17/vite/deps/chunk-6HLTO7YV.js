...
(function(Disposable2) {
  function create(callback) {
    return {
      dispose: () => __async(this, null, function* () {
...
var DefaultWorkspaceLock = class {
  ...
  performNextOperation() {
    return __async(this, null, function* () {
      ...
      this.done = false;
      yield Promise.all(entries.map((_0) => __async(this, [_0], function* ({ action, deferred, cancellationToken }) {
        try {
...
var DefaultHydrator = class {
  ...
  dehydrate(result) {
    return {
      ...
      parserErrors: result.parserErrors.map((e) => __spreadProps(__spreadValues({}, e), { message: e.message })),
...
//# sourceMappingURL=chunk-6HLTO7YV.js.map

...
import {
  at
} from "./chunk-ECTFSZFC.js";
import {
  compileStyles,
  solidStateFill,
  styles2String,
  userNodeOverrides
} from "./chunk-YSZUUOM3.js";
import {
  createText,
  getIconSVG
...
var labelHelper = __name((parent, node, _classes) => __async(void 0, null, function* () {
  let cssClasses;
...
var insertLabel = __name((parent, label, options) => __async(void 0, null, function* () {
...
var roundedWithTitle = __name((parent, node) => __async(void 0, null, function* () {
  const siteConfig = getConfig2();
  const { themeVariables, handDrawnSeed } = siteConfig;
...
var kanbanSection = __name((parent, node) => __async(void 0, null, function* () {
  log.info("Creating subgraph rect for ", node.id, node);
  const siteConfig = getConfig2();
  const { themeVariables, handDrawnSeed } = siteConfig;
  const { clusterBkg, clusterBorder } = themeVariables;
...
var insertCluster = __name((elem, node) => __async(void 0, null, function* () {
...
function bowTieRect(parent, node) {
  return __async(this, null, function* () {
    ...
    const { shapeSvg, bbox } = yield labelHelper(parent, node, getNodeClasses(node));
...
function circle(parent, node, options) {
  return __async(this, null, function* () {
    const { labelStyles, nodeStyles } = styles2String(node);
    node.labelStyle = labelStyles;
    const { shapeSvg, bbox, halfPadding } = yield labelHelper(parent, node, getNodeClasses(node));
...
function curlyBraceLeft(parent, node) {
  return __async(this, null, function* () {
    const { labelStyles, nodeStyles } = styles2String(node);
    node.labelStyle = labelStyles;
    const { shapeSvg, bbox, label } = yield labelHelper(parent, node, getNodeClasses(node));
...
function hourglass(parent, node) {
  return __async(this, null, function* () {
    ...
    node.label = "";
    node.labelStyle = labelStyles;
    const { shapeSvg } = yield labelHelper(parent, node, getNodeClasses(node));
...
function icon(_0, _1, _2) {
  return __async(this, arguments, function* (parent, node, { config: { themeVariables, flowchart } }) {
    const { labelStyles } = styles2String(node);
    node.labelStyle = labelStyles;
    ...
    const { shapeSvg, bbox, label } = yield labelHelper(parent, node, "icon-shape default");
...
function iconRounded(_0, _1, _2) {
  return __async(this, arguments, function* (parent, node, { config: { themeVariables, flowchart } }) {
    ...
    const defaultWidth = flowchart?.wrappingWidth;
    node.width = Math.max(iconSize, defaultWidth ?? 0);
    const { shapeSvg, bbox, halfPadding, label } = yield labelHelper(
      parent,
      node,
      "icon-shape default"
    );
...
function imageSquare(_0, _1, _2) {
  return __async(this, arguments, function* (parent, node, { config: { flowchart } }) {
    const img = new Image();
    img.src = node?.img ?? "";
    yield img.decode();
    ...
    const { shapeSvg, bbox, label } = yield labelHelper(parent, node, "image-shape default");
    const topLabel = node.pos === "t";
...
function labelRect(parent, node) {
  return __async(this, null, function* () {
    const { shapeSvg, bbox, label } = yield labelHelper(parent, node, "label");
    const rect2 = shapeSvg.insert("rect", ":first-child");
...
function note(_0, _1, _2) {
  return __async(this, arguments, function* (parent, node, { config: { themeVariables } }) {
    const { labelStyles, nodeStyles } = styles2String(node);
    node.labelStyle = labelStyles;
...
function erBox(parent, node) {
  return __async(this, null, function* () {
    ...
    for (const attribute of entityNode.attributes) {
      ...
      const commentBBox = yield addText(
        shapeSvg,
        attribute.comment,
        config,
        0,
...
function textHelper(_0, _1, _2, _3) {
  return __async(this, arguments, function* (parent, node, config, useHtmlLabels, GAP = config.class.padding ?? 12) {
    ...
    if (node.annotations.length > 0) {
      ...
      yield addText2(annotationGroup, { text: `«${annotation}»` }, 0);
...
function classBox(parent, node) {
  return __async(this, null, function* () {
    ...
    const { shapeSvg, bbox } = yield textHelper(parent, node, config, useHtmlLabels, GAP);
    const { labelStyles, nodeStyles } = styles2String(node);
    node.labelStyle = labelStyles;
...
function requirementBox(parent, node) {
  return __async(this, null, function* () {
    ...
    const nameHeight = yield addText3(
      shapeSvg,
    ...
    if (isRequirementNode) {
      ...
      const textHeight = yield addText3(
        shapeSvg,
      ...
      const riskHeight = yield addText3(
        shapeSvg,
      ...
      const typeHeight2 = yield addText3(
        shapeSvg,
...
function kanbanItem(_0, _1, _2) {
  return __async(this, arguments, function* (parent, kanbanNode, { config }) {
    ...
    let labelEl, bbox2;
    if (link) {
      ({ label: labelEl, bbox: bbox2 } = yield insertLabel(
        link,
    ...
    const { label: labelElAssigned, bbox: bboxAssigned } = yield insertLabel(
      shapeSvg,
...
//# sourceMappingURL=chunk-AMBXLUPQ.js.map

...
var defaultSequenceOptions = __spreadProps(__spreadValues({}, defaultUnicodeOptions), {
  separator: "-"
});
...
var getRegisteredIconData = __name((iconName, fallbackPrefix) => __async(void 0, null, function* () {
...
var isIconAvailable = __name((iconName) => __async(void 0, null, function* () {
  try {
...
var getIconSVG = __name((iconName, customisations, extraAttributes) => __async(void 0, null, function* () {
  let iconData;
  try {
      ...
      pendingReplacements.push(
        (() => __async(this, null, function* () {
          ...
          if (yield isIconAvailable(registeredIconName)) {
            return yield getIconSVG(registeredIconName, void 0, { class: "label-icon" });
          } else {
...
var createText = __name((_0, ..._1) => __async(void 0, [_0, ..._1], function* (el, text = "", {
  style = "",
  isTitle = false,
  classes = "",
  useHtmlLabels = true,
...
//# sourceMappingURL=chunk-GE5V2RNI.js.map

...
var registerDefaultLayoutLoaders = __name(() => {
  registerLayoutLoaders([
    {
      name: "dagre",
      loader: __name(() => __async(void 0, null, function* () {
        return yield import("./dagre-KV5264BT-BN5LQEFQ.js");
      }), "loader")
    },
    ...true ? [
      {
        name: "cose-bilkent",
        loader: __name(() => __async(void 0, null, function* () {
          return yield import("./cose-bilkent-S5V4N54A-KX3UPF7Y.js");
        }), "loader")
      }
    ] : []
  ]);
...
//# sourceMappingURL=chunk-LWO7NDHD.js.map

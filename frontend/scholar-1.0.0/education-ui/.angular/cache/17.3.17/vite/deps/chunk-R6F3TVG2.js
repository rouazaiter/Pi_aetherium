...
var calculateMathMLDimensions = __name((text2, config2) => __async(void 0, null, function* () {
...
var renderKatexUnsanitized = __name((text2, config2) => __async(void 0, null, function* () {
  if (!hasKatex(text2)) {
    return text2;
  }
  ...
  if (true) {
    const { default: katex } = yield import("./katex-34UFAGFA.js");
...
var renderKatexSanitized = __name((text2, config2) => __async(void 0, null, function* () {
...
var getStyles = __name((type, userStyles, options, svgId) => {
  ...
  if (type in themes && themes[type]) {
    diagramStyles = themes[type](__spreadProps(__spreadValues({}, options), { svgId }));
  } else {
...
*/
//# sourceMappingURL=chunk-R6F3TVG2.js.map

...
var render = __name((_0, _1, _2, _3) => __async(void 0, [_0, _1, _2, _3], function* (data4Layout, svg, {
  insertCluster,
  insertEdge,
  insertEdgeLabel,
  insertMarkers,
  ...
  yield Promise.all(
    data4Layout.nodes.map((node) => __async(void 0, null, function* () {
      if (node.isGroup) {
  ...
  yield Promise.all(
    data4Layout.edges.map((edge) => __async(void 0, null, function* () {
...
//# sourceMappingURL=cose-bilkent-S5V4N54A-KX3UPF7Y.js.map

...
var recursiveRender = __name((_elem, graph, diagramType, id, parentCluster, siteConfig) => __async(void 0, null, function* () {
      ...
      return __async(this, null, function* () {
        ...
        if (node?.clusterNode) {
          ...
          if (graph.children(v).length > 0) {
            ...
            yield insertNode(nodes, graph.node(v), { config: siteConfig, dir });
          }
        }
      });
    })
  );
  const processEdges = __name(() => __async(void 0, null, function* () {
  ...
  yield Promise.all(
    sortNodesByHierarchy(graph).map(function(v) {
      return __async(this, null, function* () {
        const node = graph.node(v);
        log.info(
...
var render = __name((data4Layout, svg) => __async(void 0, null, function* () {
...
//# sourceMappingURL=dagre-KV5264BT-BN5LQEFQ.js.map

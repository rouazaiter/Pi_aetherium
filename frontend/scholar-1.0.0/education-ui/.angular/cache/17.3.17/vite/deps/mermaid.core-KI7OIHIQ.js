...
import {
  JSON_SCHEMA,
  load
} from "./chunk-LFJYRY4R.js";
import {
  registerLayoutLoaders
} from "./chunk-LWO7NDHD.js";
import "./chunk-IEM624IE.js";
import "./chunk-YA547GGI.js";
import "./chunk-AMBXLUPQ.js";
import "./chunk-PGOY7VLQ.js";
import "./chunk-ECTFSZFC.js";
import "./chunk-YSZUUOM3.js";
import {
  dedent,
  registerIconPacks
} from "./chunk-GE5V2RNI.js";
import {
  cleanAndMerge,
  decodeEntities,
  encodeEntities,
...
var loader = __name(() => __async(void 0, null, function* () {
  const { diagram: diagram2 } = yield import("./c4Diagram-AHTNJAMY-C36RWUAW.js");
...
var loader2 = __name(() => __async(void 0, null, function* () {
  const { diagram: diagram2 } = yield import("./flowDiagram-DWJPFMVM-BENGJ42D.js");
...
var loader3 = __name(() => __async(void 0, null, function* () {
  const { diagram: diagram2 } = yield import("./flowDiagram-DWJPFMVM-BENGJ42D.js");
...
var loader4 = __name(() => __async(void 0, null, function* () {
  const { diagram: diagram2 } = yield import("./erDiagram-SMLLAGMA-6YAEL3EM.js");
...
var loader5 = __name(() => __async(void 0, null, function* () {
  const { diagram: diagram2 } = yield import("./gitGraphDiagram-UUTBAWPF-6DQIOH2A.js");
...
var loader6 = __name(() => __async(void 0, null, function* () {
  const { diagram: diagram2 } = yield import("./ganttDiagram-T4ZO3ILL-NYHU6I6E.js");
...
var loader7 = __name(() => __async(void 0, null, function* () {
  const { diagram: diagram2 } = yield import("./infoDiagram-42DDH7IO-EX6PRIEB.js");
...
var loader8 = __name(() => __async(void 0, null, function* () {
  const { diagram: diagram2 } = yield import("./pieDiagram-DEJITSTG-FW6TNR6W.js");
...
var loader9 = __name(() => __async(void 0, null, function* () {
  const { diagram: diagram2 } = yield import("./quadrantDiagram-34T5L4WZ-JHNZSPSV.js");
...
var loader10 = __name(() => __async(void 0, null, function* () {
  const { diagram: diagram2 } = yield import("./xychartDiagram-5P7HB3ND-YMMUXMGP.js");
...
var loader11 = __name(() => __async(void 0, null, function* () {
  const { diagram: diagram2 } = yield import("./requirementDiagram-MS252O5E-TT3ZDHBC.js");
...
var loader12 = __name(() => __async(void 0, null, function* () {
  const { diagram: diagram2 } = yield import("./sequenceDiagram-FGHM5R23-B5JMSZC5.js");
...
var loader13 = __name(() => __async(void 0, null, function* () {
  const { diagram: diagram2 } = yield import("./classDiagram-6PBFFD2Q-ORX5XHHG.js");
...
var loader14 = __name(() => __async(void 0, null, function* () {
  const { diagram: diagram2 } = yield import("./classDiagram-v2-HSJHXN6E-S4XDZA7U.js");
...
var loader15 = __name(() => __async(void 0, null, function* () {
  const { diagram: diagram2 } = yield import("./stateDiagram-FHFEXIEX-56YHUIY2.js");
...
var loader16 = __name(() => __async(void 0, null, function* () {
  const { diagram: diagram2 } = yield import("./stateDiagram-v2-QKLJ7IA2-SA3K5JW4.js");
...
var loader17 = __name(() => __async(void 0, null, function* () {
  const { diagram: diagram2 } = yield import("./journeyDiagram-VCZTEJTY-IKRFJQWJ.js");
...
var loader18 = __name(() => __async(void 0, null, function* () {
  const { diagram: diagram2 } = yield import("./flowDiagram-DWJPFMVM-BENGJ42D.js");
...
var loader19 = __name(() => __async(void 0, null, function* () {
  const { diagram: diagram2 } = yield import("./timeline-definition-GMOUNBTQ-B7EI3WZK.js");
...
var loader20 = __name(() => __async(void 0, null, function* () {
  const { diagram: diagram2 } = yield import("./mindmap-definition-QFDTVHPH-JQU7GO5S.js");
...
var loader21 = __name(() => __async(void 0, null, function* () {
  const { diagram: diagram2 } = yield import("./kanban-definition-6JOO6SKY-L66NUNQO.js");
...
var loader22 = __name(() => __async(void 0, null, function* () {
  const { diagram: diagram2 } = yield import("./sankeyDiagram-XADWPNL6-6JUJAPD7.js");
...
var loader23 = __name(() => __async(void 0, null, function* () {
  const { diagram: diagram2 } = yield import("./diagram-TYMM5635-CAFBHOBT.js");
...
var loader24 = __name(() => __async(void 0, null, function* () {
  const { diagram: diagram2 } = yield import("./diagram-MMDJMWI5-5TWTG3VB.js");
...
var loader25 = __name(() => __async(void 0, null, function* () {
  const { diagram: diagram2 } = yield import("./blockDiagram-DXYQGD6D-5PX5N24I.js");
...
var loader26 = __name(() => __async(void 0, null, function* () {
  const { diagram: diagram2 } = yield import("./diagram-5BDNPKRD-DEA76EFP.js");
...
var loader27 = __name(() => __async(void 0, null, function* () {
  const { diagram: diagram2 } = yield import("./architectureDiagram-Q4EWVU46-6N4FEUON.js");
...
var loader28 = __name(() => __async(void 0, null, function* () {
  const { diagram: diagram2 } = yield import("./ishikawaDiagram-UXIWVN3A-LMAPBOQ5.js");
...
var loader29 = __name(() => __async(void 0, null, function* () {
  const { diagram: diagram2 } = yield import("./vennDiagram-DHZGUBPP-ZALQO55D.js");
...
var loader30 = __name(() => __async(void 0, null, function* () {
  const { diagram: diagram2 } = yield import("./diagram-G4DWMVQ6-XIB3PCWW.js");
...
var loader31 = __name(() => __async(void 0, null, function* () {
  const { diagram: diagram2 } = yield import("./wardleyDiagram-NUSXRM2D-ACC4BIZZ.js");
...
var loadRegisteredDiagrams = __name(() => __async(void 0, null, function* () {
  log.debug(`Loading registered diagrams`);
  const results = yield Promise.allSettled(
    Object.entries(detectors).map((_0) => __async(void 0, [_0], function* ([key, { detector: detector32, loader: loader32 }]) {
      if (!loader32) {
        return;
      }
      try {
        ...
        try {
          const { diagram: diagram2, id: id32 } = yield loader32();
  ...
  static fromText(_0) {
    return __async(this, arguments, function* (text, metadata = {}) {
      ...
      try {
        ...
        const { id: id32, diagram: diagram2 } = yield loader32();
...
var createUserStyles = __name((config, graphType, classDefs, svgId) => {
  ...
  const allStyles = styles_default(
    graphType,
    userCSSstyles,
    __spreadProps(__spreadValues({}, config.themeVariables), { theme: config.theme, look: config.look }),
    svgId
  );
...
var render = __name(function(id32, text, svgContainingElement) {
  return __async(this, null, function* () {
    addDiagrams();
    ...
    try {
      diag = yield Diagram.fromText(text, { title: processed.title });
    } catch (error) {
...
var runThrowsErrors = __name(function() {
  return __async(this, arguments, function* ({ postRenderCallback, querySelector, nodes } = {
    querySelector: ".mermaid"
  }) {
    ...
    for (const element of Array.from(nodesToProcess)) {
      ...
      try {
        const { svg, bindFunctions } = yield render2(id32, txt, element);
...
var init = __name(function(config, nodes, callback) {
  return __async(this, null, function* () {
...
var registerExternalDiagrams = __name((_0, ..._1) => __async(void 0, [_0, ..._1], function* (diagrams, {
  lazyLoad = true
} = {}) {
  addDiagrams();
...
var executeQueue = __name(() => __async(void 0, null, function* () {
...
var parse22 = __name((text, parseOptions) => __async(void 0, null, function* () {
...
mermaid/dist/mermaid.core.mjs:
   ...
   *)
*/
//# sourceMappingURL=mermaid.core-KI7OIHIQ.js.map

...
var drawKatex = __name(function(elem, textData, msgModel = null) {
...
var drawActor = __name(function(elem, actor, conf2, isFooter, diagramId, diagObj, actorIndexMap) {
  return __async(this, null, function* () {
    ...
    switch (actor.type) {
      ...
      case "control":
        return yield drawActorTypeControl(
          elem,
          actor,
          conf2,
          isFooter,
...
var drawLoop = __name(function(elem, loopModel, labelText, conf2, msg) {
  return __async(this, null, function* () {
    const {
      boxMargin,
      boxTextMargin,
...
var drawNote = __name(function(elem, noteModel, id) {
  return __async(this, null, function* () {
...
var drawMessage = __name(function(diagram2, msgModel, lineStartY, diagObj, msg, diagramId) {
  return __async(this, null, function* () {
    ...
    if (hasKatex(textObj.text)) {
      yield drawKatex(diagram2, textObj, { startx, stopx, starty: lineStartY });
    } else {
...
var drawActors = __name(function(diagram2, actors, actorKeys, isFooter, diagramId, diagObj, actorIndexMap) {
  return __async(this, null, function* () {
    if (!isFooter) {
      for (const actorKey of actorKeys) {
        const actor = actors.get(actorKey);
      ...
      for (const actorKey of actorKeys) {
        ...
        const height = yield svgDraw_default.drawActor(
          diagram2,
          actor,
          conf,
          true,
...
var buildNoteModel = __name(function(msg, actors, diagObj) {
  return __async(this, null, function* () {
    const fromActor = actors.get(msg.from);
    const toActor = actors.get(msg.to);
    ...
    let textDimensions = hasKatex(msg.message) ? yield calculateMathMLDimensions(msg.message, getConfig2()) : utils_default.calculateTextDimensions(
...
var calculateLoopBounds = __name(function(messages, actors, _maxWidthPerActor, diagObj) {
  return __async(this, null, function* () {
    const loops = {};
    const stack = [];
...
//# sourceMappingURL=sequenceDiagram-FGHM5R23-B5JMSZC5.js.map

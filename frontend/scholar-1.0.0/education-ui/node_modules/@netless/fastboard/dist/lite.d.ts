...
import { FastboardProps, ReplayFastboardProps } from '@netless/fastboard-ui/lite';
export * from '@netless/fastboard-ui/lite';
export { GenericIcon, Language, Theme } from '@netless/fastboard-ui/lite';

type MountProps = Omit<FastboardProps, "app">;
/**
...
type ReplayProps = Omit<ReplayFastboardProps, "player">;
/**

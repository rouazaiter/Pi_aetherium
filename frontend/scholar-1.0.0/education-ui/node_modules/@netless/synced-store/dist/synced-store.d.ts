...
import type { Displayer, InvisiblePlugin, MagixEventListenerOptions } from "white-web-sdk";
import type { MagixEventHandler, MagixEventListenerDisposer, MagixEventTypes } from "./typings";
import { Storage } from "./storage";
export declare class SyncedStore<TEventData extends Record<string, any> = any> {
    readonly displayer: Displayer;
    readonly _plugin$: ReadonlyVal<InvisiblePlugin<any, any> | null>;
    private readonly _isPluginWritable$;
    private readonly _isRoomWritable$;
    private readonly _sideEffect;
    private readonly _room;
    constructor(displayer: Displayer, invisiblePlugin$: ReadonlyVal<InvisiblePlugin<any, any> | null>, isRoomWritable$: ReadonlyVal<boolean>);

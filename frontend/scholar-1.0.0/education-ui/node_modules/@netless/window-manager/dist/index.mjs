  ...
  return new Promise((resolve, reject) => {
    ...
    request.onupgradeneeded = (event) => {
      ...
      if (!db2.objectStoreNames.contains("apps")) {
        store = db2.createObjectStore("apps", { keyPath: "kind" });
...
class TeleBox {
  constructor({
    ...
    const visualSize$ = combine(
      ...
      ([size2, minimized2, containerRect2, collectorRect2, boxStatus2]) => {
  ...
  render(root) {
    ...
    this._valSideEffectBinder.combine(
      ...
      ([coord, size2, minimized, containerRect, collectorRect, boxStatus]) => {
  ...
  focusBox(box) {
    ...
    if (this.$titles) {
      ...
      if (this.state === TELE_BOX_STATE.Maximized && !this.hasMaximizedBoxInStatus()) {
        ...
        for (let i2 = children2.length - 1; i2 >= 0; i2 -= 1) {
          const $tab = children2[i2];
          const id2 = (_b = $tab.dataset) == null ? void 0 : _b.teleBoxID;
          if (id2) {
            if (box && id2 === box.id) {
              $tab.classList.toggle(
                this.wrapClassName("titles-tab-focus"),
...
class AppMenu {
  constructor(props) {
    ...
    this.menuViewClickHandler = (e2) => {
      ...
      const id2 = target.getAttribute(`data-${this.c("app-id")}`);
      if (id2) {
        const lastNotMinimizedBoxStatus = this.manager.getLastNotMinimizedBoxStatus(id2) || TELE_BOX_STATE.Normal;
        ...
        this.manager.setBox(id2, {
          status: lastNotMinimizedBoxStatus,
          zIndex
        }, false, () => {
          this.manager.focusBox(id2);
        });
        return;
      }
    };
  ...
  renderMenuView(minimizedBoxesStatus) {
    const items = [];
    minimizedBoxesStatus.forEach((_2, appId) => {
...
class TeleBoxManager {
  constructor({
    ...
    minimized$.subscribe((minimized2, _2, skipUpdate) => {
      var _a;
  ...
  return new BoxManagerClass(
    {
      ...
      setBoxStatus: (id2, boxStatus) => {
        var _a;
        return (_a = manager.appManager) == null ? void 0 : _a.store.setBoxStatus(id2, boxStatus);
      },
      setLastNotMinimizedBoxStatus: (id2, lastNotMinimizedBoxStatus) => {
        var _a;
        return (_a = manager.appManager) == null ? void 0 : _a.store.setLastNotMinimizedBoxStatus(
          id2,
          lastNotMinimizedBoxStatus
        );
      },
...
var Fields = /* @__PURE__ */ ((Fields2) => {
  ...
  Fields2["BoxesStatus"] = "boxesStatus";
  Fields2["LastNotMinimizedBoxesStatus"] = "lastNotMinimizedBoxesStatus";
  return Fields2;
})(Fields || {});
class AttributesDelegate {
  ...
  getBoxesStatus() {
    return get(this.attributes, ["boxesStatus"]);
  }
  getBoxStatus(id2) {
    return get(this.attributes, ["boxesStatus", id2]);
  }
  setBoxStatus(id2, status) {
    const attributes = this.attributes;
    if (!attributes.boxesStatus) {
      this.context.safeSetAttributes({ boxesStatus: {} });
    }
    if (this.getBoxStatus(id2) !== status) {
      this.context.safeUpdateAttributes(["boxesStatus", id2], status);
    }
  }
  getLastNotMinimizedBoxesStatus() {
    return get(this.attributes, ["lastNotMinimizedBoxesStatus"]);
  }
  getLastNotMinimizedBoxStatus(id2) {
    return get(this.attributes, ["lastNotMinimizedBoxesStatus", id2]);
  }
  setLastNotMinimizedBoxStatus(id2, status) {
    const attributes = this.attributes;
    if (!attributes.lastNotMinimizedBoxesStatus) {
      this.context.safeSetAttributes({ lastNotMinimizedBoxesStatus: {} });
    }
    if (this.getLastNotMinimizedBoxStatus(id2) !== status) {
      this.context.safeUpdateAttributes(["lastNotMinimizedBoxesStatus", id2], status);
    }
  }
...
class AppManager {
  constructor(windowManger) {
    ...
    this.onBoxBlurred = (payload) => {
      const focus = this.attributes.focus;
      if (focus === payload.appId) {
        this.windowManger.safeSetAttributes({ focus: void 0 });
        callbacks$1.emit("onBoxBlurred", payload);
      }
    };
...
function O$2(a2) {
  return "object" === typeof a2 && null !== a2 && a2.$$typeof === p;
}
function escape(a2) {
  var b2 = { "=": "=0", ":": "=2" };
...
function aa$1(a2, b2, c2) {
  ...
  Array.isArray(a2) ? X$2(a2, e2, c2, function(a3) {
    return a3;
  }) : null != a2 && (O$2(a2) && (a2 = N$2(a2, d2 + (!a2.key || b2 && b2.key === a2.key ? "" : ("" + a2.key).replace(P$2, "$&/") + "/") + c2)), e2.push(a2));
}
...
(function(exports) {
        ...
        a:
          for (var d2 = 0, e2 = a2.length; d2 < e2; ) {
            ...
            if (void 0 !== n2 && 0 > K2(n2, c2))
              void 0 !== r2 && 0 > K2(r2, n2) ? (a2[d2] = r2, a2[v2] = c2, d2 = v2) : (a2[d2] = n2, a2[m2] = c2, d2 = m2);
  ...
  exports.unstable_scheduleCallback = function(a2, b2, c2) {
    ...
    e2 > d2 ? (a2.sortIndex = e2, J2(O2, a2), null === L2(N2) && a2 === L2(O2) && (U2 ? h2() : U2 = true, g2(W2, e2 - d2))) : (a2.sortIndex = c2, J2(N2, a2), T2 || S2 || (T2 = true, f2(X2)));
    return a2;
  };
...
function Ta(a2, b2, c2, d2) {
  if (null === b2 || "undefined" === typeof b2 || Sa(a2, b2, c2, d2))
    return true;
  if (d2)
    return false;
  if (null !== c2)
...
function Mc(a2, b2, c2, d2, e2, f2) {
  if (null === a2 || a2.nativeEvent !== f2)
    return a2 = Kc(b2, c2, d2, e2, f2), null !== b2 && (b2 = Nc(b2), null !== b2 && xc(b2)), a2;
...
function G$1(a2, b2, c2, d2) {
  ...
  for (var e2 in a2)
    a2.hasOwnProperty(e2) && ((b2 = a2[e2]) ? this[e2] = b2(c2) : "target" === e2 ? this.target = d2 : this[e2] = c2[e2]);
...
function ue(a2, b2) {
  if (se$1)
    return "compositionend" === a2 || !je && qe(a2, b2) ? (a2 = ae(), $d = Zd = Yd = null, se$1 = false, a2) : null;
  switch (a2) {
    case "paste":
      return null;
    case "keypress":
...
var ve = { eventTypes: oe, extractEvents: function(a2, b2, c2, d2) {
  ...
  if (je)
    ...
    se$1 ? qe(a2, c2) && (f2 = oe.compositionEnd) : "keydown" === a2 && 229 === c2.keyCode && (f2 = oe.compositionStart);
  f2 ? (me && "ko" !== c2.locale && (se$1 || f2 !== oe.compositionStart ? f2 === oe.compositionEnd && se$1 && (e2 = ae()) : (Yd = d2, Zd = "value" in Yd ? Yd.value : Yd.textContent, se$1 = true)), f2 = ge.getPooled(
    f2,
    b2,
    c2,
    d2
...
function Kg(a2, b2, c2, d2, e2, f2, g2) {
  a2 = a2.stateNode;
  return "function" === typeof a2.shouldComponentUpdate ? a2.shouldComponentUpdate(d2, f2, g2) : b2.prototype && b2.prototype.isPureReactComponent ? !bf(c2, d2) || !bf(e2, f2) : true;
}
function Lg(a2, b2, c2) {
  var d2 = false, e2 = Af;
  var f2 = b2.contextType;
  "object" === typeof f2 && null !== f2 ? f2 = sg(f2) : (e2 = L$1(b2) ? Bf : J$1.current, d2 = b2.contextTypes, f2 = (d2 = null !== d2 && void 0 !== d2) ? Cf(a2, e2) : Af);
  b2 = new b2(c2, f2);
...
function Ng(a2, b2, c2, d2) {
  ...
  "function" === typeof b2.getDerivedStateFromProps || "function" === typeof e2.getSnapshotBeforeUpdate || "function" !== typeof e2.UNSAFE_componentWillMount && "function" !== typeof e2.componentWillMount || (b2 = e2.state, "function" === typeof e2.componentWillMount && e2.componentWillMount(), "function" === typeof e2.UNSAFE_componentWillMount && e2.UNSAFE_componentWillMount(), b2 !== e2.state && Jg.enqueueReplaceState(e2, e2.state, null), zg(a2, c2, e2, d2), e2.state = a2.memoizedState);
...
function Rg(a2) {
  ...
  function z2(a3, b3, c3, d3, e3) {
    ...
    if ("object" === typeof d3 && null !== d3) {
      switch (d3.$$typeof) {
        case Za:
          return a3 = a3.get(null === d3.key ? c3 : d3.key) || null, d3.type === ab ? m2(b3, a3, d3.props.children, e3, d3.key) : k2(b3, a3, d3, e3);
        case $a:
  ...
  return function(a3, d3, f3, h3) {
    ...
    if ("string" === typeof f3 || "number" === typeof f3)
      return f3 = "" + f3, null !== d3 && 6 === d3.tag ? (c2(a3, d3.sibling), d3 = e2(d3, f3), d3.return = a3, a3 = d3) : (c2(a3, d3), d3 = Tg(f3, a3.mode, h3), d3.return = a3, a3 = d3), g2(a3);
    if (Og(f3))
  ...
  if (null !== e2) {
    ...
    do {
      ...
      if (l2 < lh) {
        ...
        null !== h2 && (h2 = h2.next = { expirationTime: 1073741823, suspenseConfig: k2.suspenseConfig, action: k2.action, eagerReducer: k2.eagerReducer, eagerState: k2.eagerState, next: null }), Ag(l2, k2.suspenseConfig), d2 = k2.eagerReducer === a2 ? k2.eagerState : a2(d2, k2.action);
      k2 = k2.next;
    } while (null !== k2 && k2 !== e2);
...
function Ah(a2, b2, c2, d2) {
  ...
  b2 = N$1.updateQueue;
  null === b2 ? (b2 = { lastEffect: null }, N$1.updateQueue = b2, b2.lastEffect = a2.next = a2) : (c2 = b2.lastEffect, null === c2 ? b2.lastEffect = a2.next = a2 : (d2 = c2.next, c2.next = a2, a2.next = d2, b2.lastEffect = a2));
  return a2;
}
function Bh() {
...
function R$1(a2, b2, c2, d2) {
  b2.child = null === a2 ? Yg(b2, null, c2, d2) : Xg(b2, a2.child, c2, d2);
}
...
function ai(a2, b2, c2, d2, e2, f2) {
  ...
  g2 = a2.child;
  if (e2 < f2 && (e2 = g2.memoizedProps, c2 = c2.compare, c2 = null !== c2 ? c2 : bf, c2(e2, d2) && a2.ref === b2.ref))
    return $h(a2, b2, f2);
  b2.effectTag |= 1;
  a2 = Sg(g2, d2);
  a2.ref = b2.ref;
...
function ci(a2, b2, c2, d2, e2, f2) {
  return null !== a2 && bf(a2.memoizedProps, d2) && a2.ref === b2.ref && (rg = false, e2 < f2) ? (b2.expirationTime = a2.expirationTime, $h(a2, b2, f2)) : di(a2, b2, c2, d2, f2);
}
function ei(a2, b2) {
  var c2 = b2.ref;
...
function fi(a2, b2, c2, d2, e2) {
  ...
  if (null === b2.stateNode)
    null !== a2 && (a2.alternate = null, b2.alternate = null, b2.effectTag |= 2), Lg(b2, c2, d2), Ng(b2, c2, d2, e2), d2 = true;
  else if (null === a2) {
    ...
    zg(b2, d2, g2, e2);
    k2 = b2.memoizedState;
    h2 !== d2 || x2 !== k2 || K$1.current || tg ? ("function" === typeof m2 && (Fg(b2, c2, m2, d2), k2 = b2.memoizedState), (h2 = tg || Kg(b2, c2, h2, d2, x2, k2, l2)) ? (p2 || "function" !== typeof g2.UNSAFE_componentWillMount && "function" !== typeof g2.componentWillMount || ("function" === typeof g2.componentWillMount && g2.componentWillMount(), "function" === typeof g2.UNSAFE_componentWillMount && g2.UNSAFE_componentWillMount()), "function" === typeof g2.componentDidMount && (b2.effectTag |= 4)) : ("function" === typeof g2.componentDidMount && (b2.effectTag |= 4), b2.memoizedProps = d2, b2.memoizedState = k2), g2.props = d2, g2.state = k2, g2.context = l2, d2 = h2) : ("function" === typeof g2.componentDidMount && (b2.effectTag |= 4), d2 = false);
  } else
    g2 = b2.stateNode, vg(a2, b2), h2 = b2.memoizedProps, g2.props = b2.type === b2.elementType ? h2 : ig(b2.type, h2), k2 = g2.context, l2 = c2.contextType, "object" === typeof l2 && null !== l2 ? l2 = sg(l2) : (l2 = L$1(c2) ? Bf : J$1.current, l2 = Cf(b2, l2)), m2 = c2.getDerivedStateFromProps, (p2 = "function" === typeof m2 || "function" === typeof g2.getSnapshotBeforeUpdate) || "function" !== typeof g2.UNSAFE_componentWillReceiveProps && "function" !== typeof g2.componentWillReceiveProps || (h2 !== d2 || k2 !== l2) && Mg(b2, g2, d2, l2), tg = false, k2 = b2.memoizedState, g2.state = k2, zg(b2, d2, g2, e2), x2 = b2.memoizedState, h2 !== d2 || k2 !== x2 || K$1.current || tg ? ("function" === typeof m2 && (Fg(b2, c2, m2, d2), x2 = b2.memoizedState), (m2 = tg || Kg(b2, c2, h2, d2, k2, x2, l2)) ? (p2 || "function" !== typeof g2.UNSAFE_componentWillUpdate && "function" !== typeof g2.componentWillUpdate || ("function" === typeof g2.componentWillUpdate && g2.componentWillUpdate(
      d2,
      x2,
      l2
    ), "function" === typeof g2.UNSAFE_componentWillUpdate && g2.UNSAFE_componentWillUpdate(d2, x2, l2)), "function" === typeof g2.componentDidUpdate && (b2.effectTag |= 4), "function" === typeof g2.getSnapshotBeforeUpdate && (b2.effectTag |= 256)) : ("function" !== typeof g2.componentDidUpdate || h2 === a2.memoizedProps && k2 === a2.memoizedState || (b2.effectTag |= 4), "function" !== typeof g2.getSnapshotBeforeUpdate || h2 === a2.memoizedProps && k2 === a2.memoizedState || (b2.effectTag |= 256), b2.memoizedProps = d2, b2.memoizedState = x2), g2.props = d2, g2.state = x2, g2.context = l2, d2 = m2) : ("function" !== typeof g2.componentDidUpdate || h2 === a2.memoizedProps && k2 === a2.memoizedState || (b2.effectTag |= 4), "function" !== typeof g2.getSnapshotBeforeUpdate || h2 === a2.memoizedProps && k2 === a2.memoizedState || (b2.effectTag |= 256), d2 = false);
...
function li(a2, b2, c2, d2, e2, f2) {
  ...
  null === g2 ? a2.memoizedState = { isBackwards: b2, rendering: null, renderingStartTime: 0, last: d2, tail: c2, tailExpiration: 0, tailMode: e2, lastEffect: f2 } : (g2.isBackwards = b2, g2.rendering = null, g2.renderingStartTime = 0, g2.last = d2, g2.tail = c2, g2.tailExpiration = 0, g2.tailMode = e2, g2.lastEffect = f2);
}
...
function si(a2, b2, c2) {
  ...
  switch (b2.tag) {
        ...
        if (Wh(b2)) {
          ...
          for (var g2 in f2)
            if (f2.hasOwnProperty(g2)) {
              var h2 = f2[g2];
              "children" === g2 ? "string" === typeof h2 ? d2.textContent !== h2 && (a2 = ["children", h2]) : "number" === typeof h2 && d2.textContent !== "" + h2 && (a2 = ["children", "" + h2]) : va.hasOwnProperty(g2) && null != h2 && rd(c2, g2);
            }
          switch (e2) {
            case "input":
              xb(d2);
          ...
          a2 === qd && (a2 = Nb(e2));
          a2 === qd ? "script" === e2 ? (a2 = g2.createElement("div"), a2.innerHTML = "<script><\/script>", a2 = a2.removeChild(a2.firstChild)) : "string" === typeof d2.is ? a2 = g2.createElement(e2, { is: d2.is }) : (a2 = g2.createElement(e2), "select" === e2 && (g2 = a2, d2.multiple ? g2.multiple = true : d2.size && (g2.size = d2.size))) : a2 = g2.createElementNS(a2, e2);
          a2[Md] = b2;
          a2[Nd] = d2;
          ...
          switch (e2) {
            ...
            case "textarea":
              ...
              break;
            case "option":
              null != d2.value && a2.setAttribute("value", "" + rb(d2.value));
              break;
            case "select":
              a2.multiple = !!d2.multiple;
              c2 = d2.value;
              null != c2 ? Hb(a2, !!d2.multiple, c2, false) : null != d2.defaultValue && Hb(a2, !!d2.multiple, d2.defaultValue, true);
              break;
            default:
    ...
    case 13:
      ...
      c2 = null !== d2;
      d2 = false;
      null === a2 ? void 0 !== b2.memoizedProps.fallback && Wh(b2) : (e2 = a2.memoizedState, d2 = null !== e2, c2 || null === e2 || (e2 = a2.child.sibling, null !== e2 && (f2 = b2.firstEffect, null !== f2 ? (b2.firstEffect = e2, e2.nextEffect = f2) : (b2.firstEffect = b2.lastEffect = e2, e2.nextEffect = null), e2.effectTag = 8)));
    ...
    case 19:
      ...
      if (null === f2)
            ...
            for (f2 = b2.child; null !== f2; ) {
              ...
              if (null !== a2) {
                ...
                for (d2 = b2.child; null !== d2; )
                  e2 = d2, f2 = c2, e2.effectTag &= 2, e2.nextEffect = null, e2.firstEffect = null, e2.lastEffect = null, a2 = e2.alternate, null === a2 ? (e2.childExpirationTime = 0, e2.expirationTime = f2, e2.child = null, e2.memoizedProps = null, e2.memoizedState = null, e2.updateQueue = null, e2.dependencies = null) : (e2.childExpirationTime = a2.childExpirationTime, e2.expirationTime = a2.expirationTime, e2.child = a2.child, e2.memoizedProps = a2.memoizedProps, e2.memoizedState = a2.memoizedState, e2.updateQueue = a2.updateQueue, f2 = a2.dependencies, e2.dependencies = null === f2 ? null : { expirationTime: f2.expirationTime, firstContext: f2.firstContext, responders: f2.responders }), d2 = d2.sibling;
        ...
        if (!e2)
          if (a2 = hh(f2), null !== a2) {
            if (b2.effectTag |= 64, e2 = true, c2 = a2.updateQueue, null !== c2 && (b2.updateQueue = c2, b2.effectTag |= 4), ri(d2, true), null === d2.tail && "hidden" === d2.tailMode && !f2.alternate)
      ...
      return null !== d2.tail ? (0 === d2.tailExpiration && (d2.tailExpiration = $f() + 500), c2 = d2.tail, d2.rendering = c2, d2.tail = c2.sibling, d2.lastEffect = b2.lastEffect, d2.renderingStartTime = $f(), c2.sibling = null, b2 = M$1.current, I$1(M$1, e2 ? b2 & 1 | 2 : b2 & 1), c2) : null;
  }
  throw Error(u(
    156,
    b2.tag
...
function Mi(a2, b2, c2) {
  for (var d2 = b2, e2 = false, f2, g2; ; ) {
    ...
    } else if (Ki(a2, d2, c2), null !== d2.child) {
      d2.child.return = d2;
      d2 = d2.child;
      continue;
    }
  ...
  switch (b2.tag) {
    ...
    case 5:
      ...
      if (null != c2) {
        ...
        if (null !== f2) {
          c2[Nd] = d2;
          "input" === a2 && "radio" === d2.type && null != d2.name && Bb(c2, d2);
          pd(a2, e2);
          b2 = pd(a2, d2);
          ...
          switch (a2) {
            ...
            case "textarea":
              ...
              break;
            case "select":
              b2 = c2._wrapperState.wasMultiple, c2._wrapperState.wasMultiple = !!d2.multiple, a2 = d2.value, null != a2 ? Hb(c2, !!d2.multiple, a2, false) : b2 !== !!d2.multiple && (null != d2.defaultValue ? Hb(c2, !!d2.multiple, d2.defaultValue, true) : Hb(c2, !!d2.multiple, d2.multiple ? [] : "", false));
          }
        }
      }
      return;
    ...
    case 13:
      ...
      if (null !== c2)
        a:
          for (a2 = c2; ; ) {
            if (5 === a2.tag)
              f2 = a2.stateNode, d2 ? (f2 = f2.style, "function" === typeof f2.setProperty ? f2.setProperty("display", "none", "important") : f2.display = "none") : (f2 = a2.stateNode, e2 = a2.memoizedProps.style, e2 = void 0 !== e2 && null !== e2 && e2.hasOwnProperty("display") ? e2.display : null, f2.style.display = ld("display", e2));
            else if (6 === a2.tag)
...
function $i(a2, b2, c2) {
  ...
  null !== f2 && "function" === typeof f2.componentDidCatch && (c2.callback = function() {
    "function" !== typeof d2 && (null === aj ? aj = /* @__PURE__ */ new Set([this]) : aj.add(this), Ci(a2, b2));
    var c3 = b2.stack;
...
function Z$1(a2) {
  if (0 !== a2.lastExpiredTime)
    ...
    if (0 === b2)
      ...
      b2 = 1073741823 === b2 ? eg(yj.bind(null, a2)) : dg(d2, Bj.bind(null, a2), { timeout: 10 * (1073741821 - b2) - $f() });
      a2.callbackNode = b2;
    }
  }
}
  ...
  do {
    ...
    if (0 === (X$1.effectTag & 2048)) {
      ...
      if (1 === U$1 || 1 !== X$1.childExpirationTime) {
        for (var c2 = 0, d2 = X$1.child; null !== d2; ) {
  ...
  switch (b2.tag) {
    case 2:
      ...
      if ("object" === typeof e2 && null !== e2 && "function" === typeof e2.render && void 0 === e2.$$typeof) {
        ...
        "function" === typeof g2 && Fg(b2, d2, g2, a2);
        e2.updater = Jg;
        b2.stateNode = e2;
    ...
    case 3:
      ...
      return b2;
    case 5:
      return fh(b2), null === a2 && Uh(b2), d2 = b2.type, e2 = b2.pendingProps, f2 = null !== a2 ? a2.memoizedProps : null, g2 = e2.children, Gd(d2, e2) ? g2 = null : null !== f2 && Gd(d2, f2) && (b2.effectTag |= 16), ei(a2, b2), b2.mode & 4 && 1 !== c2 && e2.hidden ? (b2.expirationTime = b2.childExpirationTime = 1, b2 = null) : (R$1(a2, b2, g2, c2), b2 = b2.child), b2;
    case 6:
      return null === a2 && Uh(b2), null;
    case 13:
      return ji(a2, b2, c2);
    case 4:
      return dh(b2, b2.stateNode.containerInfo), d2 = b2.pendingProps, null === a2 ? b2.child = Xg(b2, null, d2, c2) : R$1(a2, b2, d2, c2), b2.child;
    case 11:
    ...
    case 17:
      return d2 = b2.type, e2 = b2.pendingProps, e2 = b2.elementType === d2 ? e2 : ig(d2, e2), null !== a2 && (a2.alternate = null, b2.alternate = null, b2.effectTag |= 2), b2.tag = 1, L$1(d2) ? (a2 = true, Gf(b2)) : a2 = false, qg(b2, c2), Lg(b2, d2, e2), Ng(b2, d2, e2, c2), gi(
        null,
        b2,
        d2,
        true,
...
function fk(a2, b2, c2) {
  ...
  var d2 = new ak(a2, b2, c2), e2 = Sh(3, null, null, 2 === b2 ? 7 : 1 === b2 ? 3 : 0);
  d2.current = e2;
  e2.stateNode = d2;
  ug(e2);
  a2[Od] = d2.current;
...
function jk(a2, b2, c2) {
  ...
  return { $$typeof: $a, key: null == d2 ? null : "" + d2, children: a2, containerInfo: b2, implementation: c2 };
}
wc = function(a2) {
  if (13 === a2.tag) {
...
var I = "object" == typeof global && global && global.Object === Object && global, S = "object" == typeof self && self && self.Object === Object && self, T = I || S || Function("return this")(), C = T.Symbol, E = Object.prototype, k = E.hasOwnProperty, P = E.toString, j = C ? C.toStringTag : void 0;
...
function ee(e2, t2, i2) {
  function s2(t3) {
    0 === $[t3].playState ? (e2.playEffect(t3, i2, 0, 1, 0, 100, false, 0).then(() => {
  ...
  t2.one("ready", () => {
    ...
    _(">>> Setup", { playingId: n2, src: o2 }), e2.addListener("error", (e3) => {
      ...
      e2.getEffectCurrentPosition(n2).then((i4) => {
        const r3 = $[n2], o3 = i4 / 1e3, a2 = t2.currentTime(), l2 = 0 !== r3.previousSeekTargetTime && 0 !== r3.previousBeginSeekTime;
        if (_(`>>> EffectSecond rtc: ${o3} js: ${a2} seeking: ${l2}`, { playingId: n2 }), 0 == r3.playState)
...
class ie extends react.exports.Component {
  constructor(e2) {
    super(e2), this.alertMask = null, this.container = l.createRef(), this.controllerHiddenTimer = 0, this.syncPlayerTimer = 0, this.retryCount = 0, this.decreaseRetryTimer = 0, this.noSoundSyncCount = 0, this.everPlayed = false, this.showController = () => {
      ...
      if (this.state.NoSound && (this.noSoundSyncCount += 1) % 8 != 0)
        return;
      i2.paused() !== t2.paused && (this.debug("<<< paused -> %o", t2.paused), t2.paused ? i2.pause() : (null == (e3 = i2.play()) || e3.catch(this.catchPlayFail), this.everPlayed = true)), i2.muted() !== t2.muted && (this.debug("<<< muted -> %o", t2.muted), i2.muted(t2.muted)), i2.volume() !== t2.volume && (this.debug("<<< volume -> %o", t2.volume), i2.volume(t2.volume));
      ...
      void 0 !== l2 && ee(l2, a2, i2);
      const c2 = window.__pcmProxy;
      void 0 !== c2 && (a2.one("play", () => {
  ...
  isShowingPoster() {
    ...
    return !(null == e2 ? void 0 : e2.src) || b.some((t2) => e2.src.endsWith(t2));
  }
  render() {
    var e2, t2;
...
const se = { kind: "MediaPlayer", setup(e2) {
  ...
  if (s2.classList.add("netless-app-media-player-container"), d.render(l.createElement(te, { context: e2 }), s2), i2.mountContent(s2), e2.emitter.on("destroy", () => {
    ...
    const t3 = () => {
      "hidden" === document.visibilityState ? (console.log("[MediaPlayer]: visibilitychange -> hidden. unmount for pcmproxy"), d.unmountComponentAtNode(s2)) : (console.log("[MediaPlayer]: visibilitychange -> visible. mount for pcmproxy"), d.render(l.createElement(te, { context: e2 }), s2));
    };
...
const _WindowManager = class extends InvisiblePlugin {
  ...
  static async mount(params, extendClass) {
    ...
    _WindowManager.extendClass = extendClass;
  ...
  bindContainer(container) {
    ...
    _WindowManager.container = container;
    (_f = this.extendPluginManager) == null ? void 0 : _f.refreshContainer(container);
  }

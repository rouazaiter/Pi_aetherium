...
type FlattenVal<T> = T extends ReadonlyVal<infer TValue> ? TValue : T;
/** @internal */
...
export { FlattenVal as F, ReadonlyVal as R, ValInputsValueTuple as V, ValConfig as a, ValDisposer as b, ValSetValue as c, Val as d, ValSubscriber as e, ValCompare as f, ValEqual as g };

...
import { WhiteboardService, WhiteboardConfig, FastboardModule } from '../../../core/services/room-session/whiteboard.service';
...
@Component({
  ...
  templateUrl: './whiteboard-panel.component.html',
  styleUrls: ['./whiteboard-panel.component.scss']
})
